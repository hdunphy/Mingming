...
8. ~~[Node encounter flow](tickets/11-encounter-flow.md)~~ **CLOSED 2026-08-22** + [Rewards refit](tickets/12-rewards-refit.md) — the fight-and-grow beat.
...
Tickets 06, 07, 08, 09, 10, 11, 20, 21 and 23 are closed. Then, to make the slice *complete* rather than merely *closed*: Marketplace (13), Workshop (14), Macros (15), Drivers (16, waits on deck-archetypes 109), Elites (17), 3v3 game-side (22), Onboarding-lite (24), and the Vertical Slice playtest (25).
