# Legal and licences: entity, taxes, privacy policy, EULA, asset licence inventory (ticket 54)

- Type: wayfinder:task
- Status: open
- Assignee: 
- Blocked by: [35](35-audio-pass.md), [41](41-steamworks-account.md)
- Phase: Steam
...
Documents in `legal/`, privacy-policy URL live (GitHub Pages is fine), tax interview complete, credits screen populated.
