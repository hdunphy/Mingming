# Apply ticket 58: mini-engine starts, enemy ladder, sim gate, collection + bench (ticket 59)

- Type: wayfinder:task
- Status: open
- Assignee: 
- Blocked by: [58](58-difficulty-and-agency.md), [57](57-apply-56.md)
- Phase: Vertical Slice

## Deliverable

Ticket 58's resolution is the authority. Four work packages — split across sessions in this order if one is too big:
