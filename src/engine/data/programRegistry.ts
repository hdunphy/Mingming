...
export const ProgramRegistry: Record<string, ProgramData> = {
    ...
    'ignite_pipeline': {
        ...
        element: 'Fire', target: 'Single', category: 'Status', rarity: 'Common', baseCost: 1, constraints: [...STANDARD_CONSTRAINTS],
        actions: [{ type: 'APPLY_STATUS', status: 'Burn', stacks: 1, target: 'TARGET' }],
    },
    'magma_surge': {
        id: 'magma_surge',
        ...
        element: 'Fire', target: 'Single', category: 'Attack', rarity: 'Uncommon', baseCost: 1, constraints: [...STANDARD_CONSTRAINTS],
    ...
    'heat_sink': {
        ...
        element: 'Fire', target: 'Single', category: 'Special', rarity: 'Uncommon', baseCost: 0, constraints: [...STANDARD_CONSTRAINTS],
    ...
    'combustion': {
        ...
        element: 'Fire', target: 'Single', category: 'Attack', rarity: 'Rare', baseCost: 2, constraints: [...STANDARD_CONSTRAINTS],
        actions: [{ type: 'ATTACK', power: 40, target: 'TARGET' }],
    },
    'sulfur_cloud': {
        id: 'sulfur_cloud',
        ...
        element: 'Fire', target: 'Side', category: 'Status', rarity: 'Uncommon', baseCost: 2, constraints: [...STANDARD_CONSTRAINTS],
        actions: [{ type: 'APPLY_STATUS', status: 'Burn', stacks: 1, target: 'TARGET' }],
    },
    'surtrs_wrath': {
        id: 'surtrs_wrath',
        ...
        element: 'Fire', target: 'Single', category: 'Attack', rarity: 'Epic', baseCost: 4, constraints: [...STANDARD_CONSTRAINTS],
        actions: [{ type: 'ATTACK', power: 100, target: 'TARGET' }],
    },
    'self_immolate': {
        id: 'self_immolate',
        ...
        element: 'Fire', target: 'Self', category: 'Status', rarity: 'Common', baseCost: 0, constraints: [...STANDARD_CONSTRAINTS],
    ...
    'nova_blast': {
        ...
        element: 'Fire', target: 'All', category: 'Attack', rarity: 'Rare', baseCost: 2, constraints: [...STANDARD_CONSTRAINTS],
    ...
    'venomous_coil': {
        ...
        element: 'Water', target: 'Single', category: 'Attack', rarity: 'Common', baseCost: 1, constraints: [...STANDARD_CONSTRAINTS],
    ...
    'abyssal_grip': {
        ...
        element: 'Water', target: 'Single', category: 'Status', rarity: 'Uncommon', baseCost: 2, constraints: [{ type: 'HAS_STATUS', target: 'TARGET', value: 'Dazed' }, ...STANDARD_CONSTRAINTS],
        actions: [{ type: 'APPLY_STATUS', status: 'Stunned', stacks: 1, target: 'TARGET' }],
    },
    'murky_water': {
        id: 'murky_water',
        ...
        element: 'Water', target: 'Side', category: 'Status', rarity: 'Uncommon', baseCost: 3, constraints: [...STANDARD_CONSTRAINTS],
    ...
    'iron_hide': {
        ...
        element: 'Earth', target: 'Self', category: 'Status', rarity: 'Uncommon', baseCost: 1, constraints: [...STANDARD_CONSTRAINTS],
    ...
    'earthquake_norse': {
        ...
        element: 'Earth', target: 'Side', category: 'Attack', rarity: 'Rare', baseCost: 3, constraints: [...STANDARD_CONSTRAINTS],
        actions: [{ type: 'ATTACK', power: 40, target: 'TARGET' }],
    },
    ...
    'tailwind': {
        ...
        element: 'Air', target: 'Self', category: 'Special', rarity: 'Uncommon', baseCost: 1, constraints: [...STANDARD_CONSTRAINTS],
    ...
    'acorn_shot': {
        ...
        element: 'Nature', target: 'Single', category: 'Attack', rarity: 'Common', baseCost: 1, constraints: [...STANDARD_CONSTRAINTS],
        actions: [
            { type: 'ATTACK', power: 10, target: 'TARGET' },
    ...
    'forage': {
        ...
        element: 'Nature', target: 'Self', category: 'Special', rarity: 'Common', baseCost: 0, constraints: [...STANDARD_CONSTRAINTS],
    ...
    'squirrel_scurry': {
        ...
        element: 'Nature', target: 'Side', category: 'Attack', rarity: 'Uncommon', baseCost: 1, constraints: [...STANDARD_CONSTRAINTS],
        actions: [
            { type: 'ATTACK', power: 5, target: 'TARGET' },
            { type: 'DRAW', count: 1, target: 'SELF' }
        ],
    ...
    'nature_bond': {
        ...
        element: 'Nature', target: 'Self', category: 'Heal', rarity: 'Uncommon', baseCost: 1, constraints: [...STANDARD_CONSTRAINTS],
        actions: [
            { type: 'HEAL', power: 10, target: 'TARGET' },
            { type: 'DRAW', count: 1, target: 'SELF' }
        ],
    ...
    'glacial_age': {
        ...
        element: 'Ice', target: 'Side', category: 'Status', rarity: 'Epic', baseCost: 4, constraints: [...STANDARD_CONSTRAINTS],
        actions: [{ type: 'APPLY_STATUS', status: 'Asleep', stacks: 1, target: 'TARGET' }],
    },
    ...
    'radiant_hope': {
        ...
        element: 'Light', target: 'Side', category: 'Heal', rarity: 'Rare', baseCost: 2, constraints: [...STANDARD_CONSTRAINTS],
    ...
    'soul_siphon': {
        ...
        element: 'Dark', target: 'Single', category: 'Attack', rarity: 'Uncommon', baseCost: 1, constraints: [...STANDARD_CONSTRAINTS],
    ...
    'reboot': {
        ...
        element: 'Dark', target: 'Single', category: 'Special', rarity: 'Epic', baseCost: 5, constraints: [...STANDARD_CONSTRAINTS],
